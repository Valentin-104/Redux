...
클릭을 통해 랜덤으로 배경 색상을 바꾸고 싶었다. 색상은 hexidecimal과 rgb 2가지로 만든다. 공통적으로 중요한 것은, 0부터 임의의 숫자 사이의 자연수를 구하는 것이다.
...
[Random Color Generator](https://github.com/Valentin1495/React-Projects-for-Interview/blob/main/src/components/Random-Color-Generator)
