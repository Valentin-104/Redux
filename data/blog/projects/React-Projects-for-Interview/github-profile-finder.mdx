...
[Github Profile Finder](https://github.com/Valentin1495/React-Projects-for-Interview/tree/main/src/components/Github-Profile-FInder)
...
```ts:src/components/Github-Profile-FInder/format-date.ts
