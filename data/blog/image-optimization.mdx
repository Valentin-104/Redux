...
이를 해결하기 위하여 구글과 유튜브를 검색한 결과, 한 유용한 사이트를 발견하였다. 
...
위 사이트를 통하여 각 스크린 사이즈마다 어느 정도 크기로 다운로드해야하는지를 알아내어, 그대로 적용하였다. 결과는 성공적이었다. 스크린 사이즈에 따라 그에 맞는 크기의 이미지를 다운로드하였고, lighthouse 경고가 모두 사라졌다.